...
<!--        <img src="../../../public/logo.jpg" alt="" width="180" height="140" style="float: left;">-->
  ...
  methods: {
    async setSearch (key) {
      if (key) {
        ...
        if (this.searchInput) this.$router.push({ name: 'List', params: { key: this.setSearch() } })
        else this.$router.push({ name: 'List', params: {} })
      }
    }
  }
}
